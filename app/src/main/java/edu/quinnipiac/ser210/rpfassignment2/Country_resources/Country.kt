...
data class Country(
 ...
 val CountryList = listOf<Country>(
            Country("India", R.drawable.india, "Indian Rupe", "100 million people come to India's Kumbh Mela Festival, the world's biggest gathering of humans", R.drawable.india_map),
